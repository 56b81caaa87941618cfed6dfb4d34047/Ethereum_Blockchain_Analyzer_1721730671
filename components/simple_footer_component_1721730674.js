...
*/
Vue.component("simple_footer_component_1721730674", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EtherView - Ethereum Blockchain Explorer
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Gain real-time insights into new Ethereum blockchains as they emerge. EtherView provides advanced analytics and monitoring tools to help you stay ahead of the curve.
                    </div>
                </div>
            </div>
        </footer> 
